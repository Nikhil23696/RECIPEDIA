  ...
  return (
    ...
    >
      ...
      >
        ...
        <><FaArrowLeft className="text-inherit" /><span className="font-medium text-base">Back to {recipe.category}</span></>
      </motion.div>
      ...
      <div className="absolute inset-0 overflow-hidden rounded-b-3xl">
        <><picture>
          ...
          <motion.img
            ...
            loading="lazy" />
        </picture><div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" /></>
      </div>
